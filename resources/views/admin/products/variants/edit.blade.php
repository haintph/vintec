...
@section('title', 'Sửa biến thể - ' . $variant->name)
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0">Sửa biến thể: {{ $variant->name }}</h4>
                    </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="price"
                                                ...
                                                value="{{ old('price', $variant->price) }}" min="0" step="1000"
                                                required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <!-- Current Image -->
                                        <div class="mt-2">
                                            <img id="image-preview" src="{{ $variant->image_url }}" class="img-thumbnail"
