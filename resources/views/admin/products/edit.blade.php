...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3">Chỉnh sửa: {{ $product->name }}</h1>
            <div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Slug hiện tại: {{ $product->slug }}</small>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                @error('price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Giá hiện tại:
                                    {{ number_format($product->price ?? 0, 0, ',', '.') }} VNĐ</small>
                            </div>
            ...
            `;
                            ...
                            <div class="mb-3">
                                ...
                                <div id="specs-container">
                                    @php
                                        $specsRaw = old('specs') ?: $product->specs;
                                        $specs = [];

                                        if (is_array($specsRaw)) {
                                            $specs = $specsRaw;
                                        } elseif (is_string($specsRaw)) {
                                ...
                                {{-- Hidden textarea sẽ chứa JSON khi submit --}}
                                <textarea name="specs" id="specs-json" class="form-control d-none @error('specs') is-invalid @enderror">{{ old('specs', is_string($product->specs) ? $product->specs : json_encode($product->specs)) }}</textarea>
                        ...
                        <div class="card-body">
                            @if ($product->image)
                                <div class="mb-3 text-center">
                                    ...
                                    <p class="mt-2 small text-muted">Ảnh hiện tại</p>
                                </div>
                            @endif
                            <div class="mb-3">
        ...
        `;
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="meta_description" rows="3" maxlength="160">{{ old('meta_description', $product->meta_description) }}</textarea>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <small class="text-muted">Ngày tạo: {{ $product->created_at->format('d/m/Y H:i') }}</small>
                        </div>
                    </div>
                </div>
            </div>
