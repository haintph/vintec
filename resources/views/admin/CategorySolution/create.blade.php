    ...
    <div class="container-xxl">
        <div class="row">
            <div class="col-xl-3 col-lg-4">
                <h3>Create Category Solution</h3>                  
            </div>

            <div class="col-xl-9 col-lg-8">
                <form action="{{ route('category_solution_store') }}" method="post">
                    @csrf
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                                            value="{{ old('name') }}" placeholder="Tin tức hôm nay" required>
                                        @error('name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="form-text text-muted">Slug sẽ được tự động tạo từ tên danh mục khi thay đổi tên</small>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="slug" id="slug" class="form-control @error('slug') is-invalid @enderror"
                                            value="{{ old('slug') }}" placeholder="tin-hom-nay">
                                        @error('slug')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" id="description" rows="4" 
                                            ...
                                            placeholder="Tin tức hôm nay">{{ old('description') }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="meta_title" id="meta_title" 
                                            ...
                                            value="{{ old('meta_title') }}" placeholder="Tin tức hôm nay">
                                        @error('meta_title')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <div class="text-end">
                                            <small class="text-muted">Tối đa 255 ký tự</small>
                                            <span id="meta_title_count" class="text-info">{{ strlen(old('meta_title', '')) }}/255 ký tự</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="url" name="canonical_url" id="canonical_url" 
                                            ...
                                            value="{{ old('canonical_url') }}" placeholder="https://example.com/category-name">
                                        @error('canonical_url')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="text-end">
                                            ...
                                            <span id="meta_description_count" class="text-info">{{ strlen(old('meta_description', '')) }}/160 ký tự</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="meta_keywords" id="meta_keywords" 
                                            ...
                                            value="{{ old('meta_keywords') }}" placeholder="tinhot,tinnong,tinhomnay">
                                        @error('meta_keywords')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
