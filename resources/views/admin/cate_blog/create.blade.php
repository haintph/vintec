    ...
    <div class="container-xxl">
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-8 ">
                <form action="{{ isset($category) ? route('cate_blog.update', $category->id) : route('cate_blog.store') }}" 
                      method="post">
                    @csrf
                    @if(isset($category))
                        @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" id="description" rows="4" 
                                            ...
                                            placeholder="Nhập mô tả cho danh mục">{{ old('description', isset($category) ? $category->description : '') }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="meta_description" id="meta_description" rows="3" 
                                            ...
                                            placeholder="Mô tả SEO">{{ old('meta_description', isset($category) ? $category->meta_description : '') }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="url" name="canonical_url" id="canonical_url" 
                                            ...
                                            value="{{ old('canonical_url', isset($category) ? $category->canonical_url : '') }}"
                                    ...
                                    @if(isset($category))
                                        <div class="mb-3">
                                            ...
                                            <div class="bg-light p-3 rounded">
                                                ...
                                                <p class="mb-1"><strong>Số bài viết:</strong> {{ $category->posts_count ?? 0 }}</p>
                                                <p class="mb-1"><strong>Ngày tạo:</strong> {{ $category->created_at->format('d/m/Y H:i') }}</p>
                                                <p class="mb-0"><strong>Cập nhật lần cuối:</strong> {{ $category->updated_at->format('d/m/Y H:i') }}</p>
                                            </div>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="alert alert-info">
                                        ...
                                        <ul class="mb-0">
                                            <li>Tên danh mục là trường bắt buộc và sẽ hiển thị trên website</li>
                                            <li>Slug sẽ được tự động tạo từ tên danh mục nếu bạn không nhập</li>
                                            <li>Các thông tin SEO giúp tối ưu hóa trang danh mục trên công cụ tìm kiếm</li>
                                            <li>Mô tả sẽ hiển thị trên trang danh mục để giới thiệu về chủ đề</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="p-3 bg-light mb-3 rounded">
                        <div class="row justify-content-end g-2">
                            ...
                            <div class="col-lg-2">
                                <a href="{{ route('cate_blog.index') }}" class="btn btn-primary w-100">Cancel</a>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (metaTitle) {
                ...
                if (titleHelp && titleHelp.classList.contains('form-text')) {
                    ...
                    counter.className = 'float-end';
                    counter.textContent = `${metaTitle.value.length}/255 ký tự`;
            ...
            if (metaDescription) {
                ...
                if (descHelp && descHelp.classList.contains('form-text')) {
                    ...
                    counter.className = 'float-end';
                    counter.textContent = `${metaDescription.value.length}/160 ký tự`;
